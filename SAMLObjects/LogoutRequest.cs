...
public class LogoutRequest {
    ...
    public LogoutRequest(string Destination, string thisurl, string sessionIndex, string NameId, string Issuer) {
        ...
        this.NameID.Format = "urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress";
    ...
    */
    /**/
    [XmlElement(ElementName = "NameID", Namespace = "urn:oasis:names:tc:SAML:2.0:assertion", Order = 2)]
    public NameID NameID = new NameID();
    /**/
