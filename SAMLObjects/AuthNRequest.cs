...
public class AuthnRequest {
    ...
    public AuthnRequest(string Destination, string entityID, string thisurl, string Issuer) {
        ...
        this.NameIDPolicy.SPNameQualifier = entityID;
    }

    [XmlAttribute(AttributeName = "ID")]

    public string ID = "_" + Guid.NewGuid().ToString().Replace("-", ""); // (new Random()).Next().ToString();
